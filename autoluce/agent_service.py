...
from autoluce.agent_domain import (
    TASK_CAPABILITY,
...
from autoluce.agent_repository import AgentRepository, serialize_artifact
from autoluce.coordination import CandidateRequest, FleetSnapshot, Job
from autoluce.identifiers import stable_id
...
class AgentService:
    ...
    def _packet(
        ...
        return TaskPacket(
            ...
            forbidden_paths=[
                "benchmarks/", "autoluce/", "models/", "server/test/", "server/tests/",
            ...
            test_command="uv run autoluce worker --once --simulate",
